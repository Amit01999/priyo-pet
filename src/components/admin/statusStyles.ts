...
export const PAYMENT_STATUS_BADGE_CLASSES: Record<PaymentStatus, string> = {
  'Pending Verification': 'bg-secondary/15 text-secondary border-transparent hover:bg-secondary/20',
  Verified: 'bg-green-100 text-green-700 border-transparent hover:bg-green-200',
  Rejected: 'bg-destructive/15 text-destructive border-transparent hover:bg-destructive/20',
};
